      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between mb-0">
          ...
          <div className="flex items-center gap-3">
            <button className="px-4 py-2 bg-green-600 text-white rounded-md text-sm hover:bg-green-700 hover:text-green-900">
              {"Xuất PDF"}
            </button>
          </div>
        </div>
        ...
        <section className="w-full bg-white rounded-lg shadow-sm p-6">
          ...
          {user?.roleId === 2 && (
            <div className="mt-6">
              <h3 className="font-semibold text-green-800 mb-2">Đánh giá</h3>
              <textarea
