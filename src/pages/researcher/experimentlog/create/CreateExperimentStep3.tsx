...
const CreateExperimentStep3 = () => {
  ...
  const selectedMotherName =
    hybridizationNames?.[0] ?? form.motherName ?? "Chưa chọn";
        ...
        >
          ...
          <div className="p-6 md:p-8 space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-slate-50/50 p-5 border border-slate-100 rounded-xl flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-2xl font-black text-[#1e3e1c]">
                      {numberOfSample ?? "-"}
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <div className="bg-[#E4F0E8] p-5 border border-[#DDEEE0] rounded-xl">
                  <p className="text-xs font-semibold text-[#2D5A27] uppercase tracking-wider mb-1">
                    Phương pháp
                  </p>
                  <p className="text-base font-bold text-[#1e3e1c]">
                    {methodName ?? "Chưa chọn"}
                  </p>
                  <p className="text-xs text-[#2D5A27]/80 mt-1">
                    Loại: {methodType ?? "---"}
                  </p>
                </div>
                <div className="bg-slate-50/50 p-5 border border-slate-100 rounded-xl">
                ...
                <div className="bg-white p-5 border-2 border-dashed border-slate-200 rounded-xl shadow-sm">
                  ...
                  <p className="text-lg font-bold text-[#1e3e1c] mt-1">
                    🌱 {selectedMotherName}
                  </p>
                </div>
              </div>
            ...
            <div className="pt-4 border-t border-slate-100">
              <label
                htmlFor="description"
                className="block text-sm font-semibold text-slate-700 mb-2 items-center gap-2"
              >
                <FileText className="w-4 h-4 text-[#2D5A27]" /> Ghi chú / Mô tả
                chi tiết
              </label>
              <textarea
                id="description"
          ...
          <div className="px-6 py-5 bg-slate-50 border-t border-slate-100 flex justify-between items-center">
            <Link
              ...
              className="px-5 py-2.5 text-slate-600 hover:bg-slate-200 rounded-xl font-medium transition-colors flex items-center gap-2"
            >
            ...
            >
              {isSubmitting ? (
                ...
                <>
                  <CheckCircle className="w-4 h-4" /> Hoàn thành & Tạo mới
                </>
              )}
            </button>
          </div>
